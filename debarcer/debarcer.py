#!/apps/bio/software/anaconda2/envs/debarcer/bin/python3
import argparse
import configparser
import pickle
import sys
...
if __name__ == '__main__':
	...
	p_parser.add_argument('-pf', '--prepfile', help='Path to your library_prep_types.ini file. (Default=%(default)s)',default='/apps/bio/software/debarcer/debarcer-2.0.1-alpha/config/library_prep_types.ini')
	p_parser.add_argument('-c', '--config', help='Path to your config file.(Default=%(default)s)',default='/apps/bio/software/debarcer/debarcer-2.0.1-alpha/config/sample_config.ini')
